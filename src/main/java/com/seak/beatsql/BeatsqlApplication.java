...
public class BeatsqlApplication {
    ...
    public SqlManagerFactoryBean getSqlManagerFactoryBean(@Qualifier("datasource") DataSource datasource) {
        ...
        factory.setNc( new UnderlinedNameConversion()); //Open the hump
        factory.setSqlLoader( new ClasspathLoader( "/sql" )); //sql file path
        return factory;
    }
